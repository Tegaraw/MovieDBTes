...
public class com_example_moviedb_model_ModelTVRealmProxy extends com.example.moviedb.model.ModelTV
    implements RealmObjectProxy, com_example_moviedb_model_ModelTVRealmProxyInterface {
    ...
    private ProxyState<com.example.moviedb.model.ModelTV> proxyState;

    com_example_moviedb_model_ModelTVRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.example.moviedb.model.ModelTV>(this);
    ...
    @SuppressWarnings("cast")
    public static com.example.moviedb.model.ModelTV createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.example.moviedb.model.ModelTV obj = realm.createObjectInternal(com.example.moviedb.model.ModelTV.class, true, excludeFields);

        final com_example_moviedb_model_ModelTVRealmProxyInterface objProxy = (com_example_moviedb_model_ModelTVRealmProxyInterface) obj;
        if (json.has("Id")) {
            if (json.isNull("Id")) {
    ...
    public static com.example.moviedb.model.ModelTV createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.example.moviedb.model.ModelTV obj = new com.example.moviedb.model.ModelTV();
        final com_example_moviedb_model_ModelTVRealmProxyInterface objProxy = (com_example_moviedb_model_ModelTVRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.example.moviedb.model.ModelTV copyOrUpdate(Realm realm, com.example.moviedb.model.ModelTV object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.example.moviedb.model.ModelTV) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.example.moviedb.model.ModelTV copy(Realm realm, com.example.moviedb.model.ModelTV newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.example.moviedb.model.ModelTV realmObject = realm.createObjectInternal(com.example.moviedb.model.ModelTV.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_example_moviedb_model_ModelTVRealmProxyInterface realmObjectSource = (com_example_moviedb_model_ModelTVRealmProxyInterface) newObject;
        com_example_moviedb_model_ModelTVRealmProxyInterface realmObjectCopy = (com_example_moviedb_model_ModelTVRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.example.moviedb.model.ModelTV object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.example.moviedb.model.ModelTV.class);
        long tableNativePtr = table.getNativePtr();
        ModelTVColumnInfo columnInfo = (ModelTVColumnInfo) realm.getSchema().getColumnInfo(com.example.moviedb.model.ModelTV.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Table.nativeSetLong(tableNativePtr, columnInfo.IdIndex, rowIndex, ((com_example_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$Id(), false);
        String realmGet$Name = ((com_example_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$Name();
        if (realmGet$Name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.NameIndex, rowIndex, realmGet$Name, false);
        }
        Table.nativeSetDouble(tableNativePtr, columnInfo.VoteAverageIndex, rowIndex, ((com_example_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$VoteAverage(), false);
        String realmGet$Overview = ((com_example_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$Overview();
        if (realmGet$Overview != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.OverviewIndex, rowIndex, realmGet$Overview, false);
        }
        String realmGet$ReleaseDate = ((com_example_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$ReleaseDate();
        ...
        String realmGet$PosterPath = ((com_example_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$PosterPath();
        ...
        String realmGet$BackdropPath = ((com_example_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$BackdropPath();
        ...
        String realmGet$Popularity = ((com_example_moviedb_model_ModelTVRealmProxyInterface) object).realmGet$Popularity();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ModelTVColumnInfo columnInfo = (ModelTVColumnInfo) realm.getSchema().getColumnInfo(com.example.moviedb.model.ModelTV.class);
        com.example.moviedb.model.ModelTV object = null;
        while (objects.hasNext()) {
            object = (com.example.moviedb.model.ModelTV) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.example.moviedb.model.ModelTV object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.example.moviedb.model.ModelTV.class);
    ...
    public static com.example.moviedb.model.ModelTV createDetachedCopy(com.example.moviedb.model.ModelTV realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.example.moviedb.model.ModelTV unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.example.moviedb.model.ModelTV();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.example.moviedb.model.ModelTV) cachedObject.object;
            }
            unmanagedObject = (com.example.moviedb.model.ModelTV) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_example_moviedb_model_ModelTVRealmProxyInterface unmanagedCopy = (com_example_moviedb_model_ModelTVRealmProxyInterface) unmanagedObject;
        com_example_moviedb_model_ModelTVRealmProxyInterface realmSource = (com_example_moviedb_model_ModelTVRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_example_moviedb_model_ModelTVRealmProxy aModelTV = (com_example_moviedb_model_ModelTVRealmProxy)o;
